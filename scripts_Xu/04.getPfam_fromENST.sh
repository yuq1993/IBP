#input file: target_ENST_AAseq.fa (after run 03.getAAfromENST.py) => run pfam software get domain info
#output file: ENST_pfam.txt
#make sure pfam_scan.pl is executable
#need to specify PfamScan folder

#this command should go to pfam folder(or make sure pfam_scan.pl works in this folder)
